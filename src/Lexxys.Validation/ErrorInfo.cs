...
public class ErrorInfo
{
	...
	public IReadOnlyList<ErrorAttrib> Attributes { get; }

	public ErrorInfo(ErrorCode code, ErrorDataType dataType, IEnumerable<ErrorAttrib>? attributes)
	{
		Code = code;
		DataType = dataType;
		Attributes = attributes as IReadOnlyList<ErrorAttrib> ?? ReadOnly.WrapCopy(attributes) ?? ReadOnly.Empty<ErrorAttrib>();
	}

	public ErrorInfo(ErrorCode code, ErrorDataType dataType, params ErrorAttrib[]? attributes)
	{
		Code = code;
		DataType = dataType;
		Attributes = attributes ?? Array.Empty<ErrorAttrib>();
	}
