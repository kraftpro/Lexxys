...
public sealed class ErrorNotification: ICollection<FieldError>, ICollection
{
	...
	{
		if (IsReadOnly)
			throw new NotSupportedException(Lexxys.SR.OperationNotSupported("Add"));
	...
	{
		if (IsReadOnly)
			throw new NotSupportedException(Lexxys.SR.OperationNotSupported("Clear"));
		_errors.Clear();
	}
...
public class FieldError
{
	...
	public static bool Equals(FieldError? left, FieldError? right)
		...
		Comparer.Equals(left._arguments, right._arguments);
	...
	public override string ToString()
	{
		...
		if (_arguments == null) return sb.ToString();
