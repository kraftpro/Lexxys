...
public static class CollectionExtensions
{
	...
	[return: MaybeNull]
	public static T LastOrDefault<T>(this IReadOnlyList<T> list, Predicate<T> match)
	{
	...
	public static void CopyTo<T>(this IReadOnlyCollection<T> value, T[] array, int index)
	{
		...
		if (array.Length < value.Count + index) throw new ArgumentException("The number of elements in the source is greater than the available space from index to the end of the destination array.");
